...
export function ChatWindow() {
  ...
  return (
    <main className="flex h-full flex-col">
      <header className="chat-head flex items-center justify-between border-b border-border bg-surface px-6 py-4">
        <div>
          <h2 className="text-base font-semibold text-text">{t('header.title')}</h2>
      ...
      <div className="stream flex-1 overflow-y-auto px-6 py-6">
      ...
      <div className="dock border-t border-border bg-surface px-6 py-4">
